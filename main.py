# main.py
# Garuda Concierge Premium ModMail Bot + Logs + Rotating Status
# Prefix: ?
...
async def rotate_status():
    statuses = [
        discord.Activity(type=discord.ActivityType.watching, name="Passenger Inquiries"),
...
async def reply(ctx, *, msg):
    if ctx.channel.name.startswith("ticket-"):
        ...
        if user_id:
            ...
            embed = discord.Embed(
                title="Garuda Concierge Response",
                description=msg,
                color=COLOR
            )
